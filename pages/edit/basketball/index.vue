<template>
  ...
  <view class="scheme-edit-page">
    <!-- 自定义头部：仅保留核心参数，结构不变 -->
    <CustomHeader :ballTitle="'云竞慧博体育小程序'"  :isIndex="true" title="胜负" :showBack="true" :showIcon="false" @back-click="handleBack" />
...
export default {
  ...
  data() {
    return {
      ...
      betBarFixedPx: 0, // （180rpx转px，对齐让分胜负页）
      betBarTotalHeight: 0, // （备用）
