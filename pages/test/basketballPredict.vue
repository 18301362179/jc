    ...
    <scroll-view class="scroll-content" scroll-y :scroll-into-view="currentSection" @scroll="handleScroll" :scroll-with-animation="true">
      ...
      <view id="section2" class="section">
        ...
        <view class="record-summary">
          ...
          <text class="win-text">{{ (historyData && historyData.statistics && historyData.statistics.winScoreMatchCnt) || "0" }}胜({{ (historyData && historyData.statistics && historyData.statistics.winProbability) || "0" }})</text>
          | <text class="lose-text">{{ (historyData && historyData.statistics && historyData.statistics.lossScoreMatchCnt) || "0" }}负({{ (historyData && historyData.statistics && historyData.statistics.lossProbability) || "0" }})</text>
        </view>

        <view class="table-header">
          <view class="th">日期</view>
          <view class="th">赛事</view>
        ...
        <view class="record-list">
          <view class="record-item" v-for="(item, idx) in ((historyData && historyData.matchList) || []).slice(0, historyRound)" :key="idx">
            <view class="td date-col">{{ item.matchDate || "0" }}</view>
            <view class="td league-col">{{ item.leagueShortName || "0" }}</view>
            <view class="td team-col">{{ item.homeTeamShortName || "0" }}</view>
            <view class="td score-col">{{ item.overallScore || "0" }}</view>
      ...
      <view id="section3" class="section rank">
        <view class="section-title-wrap">
          <view class="section-title">
            <view class="red-line"></view>
            积分榜 <text class="extra-text">{{ (tablesData && tablesData.leagueShortName) || "" }} {{ (tablesData && tablesData.seasonName) || "" }}</text>
          </view>
        </view>
        ...
        <view class="rank-card">
          <view class="card-header">
            <view class="team-name-tag">{{ (tablesData && tablesData.homeTables && tablesData.homeTables.total && tablesData.homeTables.total.teamShortName) || "" }}</view>
            <view class="group-rank">{{ (tablesData && tablesData.homeTables && tablesData.homeTables.total && tablesData.homeTables.total.groupName) || "" }} 第{{ (tablesData && tablesData.homeTables && tablesData.homeTables.total && tablesData.homeTables.total.ranking) || "" }}名</view>
          </view>
          ...
          <view class="table-row">
            ...
            <view class="td">{{ (tablesData && tablesData.homeTables && tablesData.homeTables.total && tablesData.homeTables.total.winScoreMatchCnt) || "0" }}/{{ (tablesData && tablesData.homeTables && tablesData.homeTables.total && tablesData.homeTables.total.lossScoreMatchCnt) || "0" }}</view>
          ...
          <view class="table-row">
            ...
            <view class="td">{{ (tablesData && tablesData.homeTables && tablesData.homeTables.home && tablesData.homeTables.home.winScoreMatchCnt) || "0" }}/{{ (tablesData && tablesData.homeTables && tablesData.homeTables.home && tablesData.homeTables.home.lossScoreMatchCnt) || "0" }}</view>
          ...
          <view class="table-row">
            ...
            <view class="td">{{ (tablesData && tablesData.homeTables && tablesData.homeTables.away && tablesData.homeTables.away.winScoreMatchCnt) || "0" }}/{{ (tablesData && tablesData.homeTables && tablesData.homeTables.away && tablesData.homeTables.away.lossScoreMatchCnt) || "0" }}</view>
        ...
        <view class="rank-card">
          <view class="card-header">
            <view class="team-name-tag">{{ (tablesData && tablesData.awayTables && tablesData.awayTables.total && tablesData.awayTables.total.teamShortName) || "" }}</view>
            <view class="group-rank">{{ (tablesData && tablesData.awayTables && tablesData.awayTables.total && tablesData.awayTables.total.groupName) || "" }} 第{{ (tablesData && tablesData.awayTables && tablesData.awayTables.total && tablesData.awayTables.total.ranking) || "" }}名</view>
          </view>
          ...
          <view class="table-row">
            ...
            <view class="td">{{ (tablesData && tablesData.awayTables && tablesData.awayTables.total && tablesData.awayTables.total.winScoreMatchCnt) || "0" }}/{{ (tablesData && tablesData.awayTables && tablesData.awayTables.total && tablesData.awayTables.total.lossScoreMatchCnt) || "0" }}</view>
          ...
          <view class="table-row">
            ...
            <view class="td">{{ (tablesData && tablesData.awayTables && tablesData.awayTables.home && tablesData.awayTables.home.winScoreMatchCnt) || "0" }}/{{ (tablesData && tablesData.awayTables && tablesData.awayTables.home && tablesData.awayTables.home.lossScoreMatchCnt) || "0" }}</view>
          ...
          <view class="table-row">
            ...
            <view class="td">{{ (tablesData && tablesData.awayTables && tablesData.awayTables.away && tablesData.awayTables.away.winScoreMatchCnt) || "0" }}/{{ (tablesData && tablesData.awayTables && tablesData.awayTables.away && tablesData.awayTables.away.lossScoreMatchCnt) || "0" }}</view>
      ...
      <view id="section4" class="section">
        ...
        <view class="team-status">
          <view class="record-summary">
            ...
            近{{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.totalLegCnt) || "0" }}场
            <text class="win-text">{{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.winScoreMatchCnt) || "0" }}胜({{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.winningProbability) || "0" }})</text>
            | <text class="lose-text">{{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.lossScoreMatchCnt) || "0" }}负({{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.lossProbability) || "0" }})</text>
          </view>
          <view class="stat-text">场均得分{{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.scoreCnt) || "0" }}，场均失分{{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.lossScoreCnt) || "0" }}，场均净胜{{ (recentData && recentData.home && recentData.home.statistics && recentData.home.statistics.netScoreCnt) || "0" }}</view>
          <view class="table-header">
          ...
          <view class="match-list">
            <view class="match-item" v-for="(item, idx) in ((recentData && recentData.home && recentData.home.matchList) || []).slice(0, matchRound)" :key="idx">
              <view class="td date-col">{{ item.leagueShortName || "0" }}<br />{{ item.matchDate || "0" }}</view>
              <view class="td team-col">{{ item.homeTeamShortName || "0" }}</view>
              <view class="td score-col">{{ item.overallScore || "0" }}</view>
              <view class="td team-col">{{ item.awayTeamShortName || "0" }}</view>
        ...
        <view class="team-status" style="margin-bottom: 40rpx;">
          <view class="record-summary">
            ...
            <text class="win-text">{{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.winScoreMatchCnt) || "0" }}胜({{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.winningProbability) || "0" }})</text>
            | <text class="lose-text">{{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.lossScoreMatchCnt) || "0" }}负({{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.lossProbability) || "0" }})</text>
          </view>
          <view class="stat-text">场均得分{{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.scoreCnt) || "0" }}，场均失分{{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.lossScoreCnt) || "0" }}，场均净胜{{ (recentData && recentData.away && recentData.away.statistics && recentData.away.statistics.netScoreCnt) || "0" }}</view>
          <view class="table-header">
            <view class="th">赛制/日期</view>
            <view class="th">主队</view>
            <view class="th">比分</view>
