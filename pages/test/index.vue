        ...
        <view class="match-header">
          ...
          <view class="prediction-section" v-if="urlValue">
            ...
            <view class="prediction-row">
              ...
              <view class="prediction-content">
                <view class="home-prediction">
                  <text class="prediction-value">{{ baseMap.home_goal_calculate || "-" }}</text>
                </view>
                <view class="draw-prediction">
                  <text class="prediction-value">:</text>
                </view>
                <view class="away-prediction">
                  <text class="prediction-value">{{ baseMap.visiting_goal_calculate || "-" }}</text>
                </view>
              </view>
            </view>
            ...
            <view class="prediction-row">
              ...
              <view class="prediction-content">
                <view class="home-prediction">
                  <text class="prediction-value">{{ baseMap.home_goal_calculate1 || "-" }}</text>
                </view>
                <view class="draw-prediction">
                  <text class="prediction-value">:</text>
                </view>
                <view class="away-prediction">
                  <text class="prediction-value">{{ baseMap.visiting_goal_calculate1 || "-" }}</text>
                </view>
              </view>
            </view>
