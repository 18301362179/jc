...
<view class="ai-analysis-btn" :class="{ 'x-text-green': item.is_buy !== 0}" v-if="item.home_win_rate && item.visiting_win_rate&&item.url_show_status==1" @click.stop="() => myValue(item)">
  <text>详细</text>
