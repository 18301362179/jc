...
exports.wxPay = exports.wxLogin = exports.setCourseGoal = exports.recharge = exports.queryTeamWordRanking = exports.queryStageList = exports.queryPlayer = exports.queryLeagueList = exports.queryHomeList = exports.queryHomeAndVisitingGoalOdds = exports.queryHhgg = exports.queryGroupAndRoundList = exports.queryFootBallLLottery = exports.queryContinentList = exports.queryBasketBallLLottery = exports.queryBasePermissionNeed = exports.purchasingLotteryQueryById = exports.purchasingLotteryConfirm = exports.purchasingLotteryApply = exports.payConfirm = exports.loginPhone = exports.getbasketballAi = exports.getUser = exports.getTimeList = exports.getSheShou = exports.getSaiCheng = exports.getJiFen = exports.getHaveMoney = exports.getAi = exports.footballLotteryTraditionDrawNum = exports.footballLotteryTradition = exports.checkSelectBasketball = exports.checkSelect = exports.checkCode = void 0;
...
var token = (0, _storage.getToken)() || ''; // 移除兜底 Token，仅目标环境自动获取

var isApp = false;
var isH5 = false;
var isMpWeixin = false; // 新增：标记微信小程序环境
    ...
    uni.request({
      ...
      success: function success(res) {
        ...
        if (res.code == 401 && isNeedToken) {
          ...
          var isTargetEnv = isApp || isMpWeixin;
          if (!isTargetEnv) {
          ...
          // 小程序/App 环境：执行自动重新登录
          (0, _auth.login)().then(function (loginResult) {
            if (loginResult.success) {
              request(options).then(function (reResolve) {
                return resolve(reResolve);
              }).catch(function (reReject) {
                return reject(reReject);
              });
            } else {
...
var _state = _interopRequireDefault(__webpack_require__(/*! ./state */ 43));
var _mutations = _interopRequireDefault(__webpack_require__(/*! ./mutations */ 44));
var _actions = _interopRequireDefault(__webpack_require__(/*! ./actions */ 45));
// store/index.js
