...
/***/ 26:
/*!*************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/pages.json ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 33:
/*!****************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/utils/auth.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _storage = __webpack_require__(/*! ./storage */ 34);
var _demo = __webpack_require__(/*! @/api/demo.js */ 35);
// utils/auth.js：完整版（兼容无 ?. 环境），实现传 code 拿 Token 并存储

// 引入你 api 文件中的 wxLogin 方法

// 替换为你的 api 文件名（如 api/football.js）

// 登录锁：防止重复请求
var isLoggingIn = false;
var login = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var loginRes, loginResult, validCode, backendRes, backendCode, backendToken, isStoreSuccess;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            ...
            backendCode = backendRes.code || backendRes.status; // 逻辑：先判断 backendRes.data 是否存在，存在再取其 token 属性，不存在则返回 undefined
            backendToken = backendRes.data || backendRes.token;
            if (!(backendCode != 200 || !backendToken)) {
              _context.next = 23;
              break;
            }
            throw new Error("\u540E\u7AEF\u8FD4\u56DE\u65E0\u6548 Token\uFF1A".concat(backendRes.msg || "登录失败"));
          case 23:
            // 步骤4：将 Token 存储到本地（持久化）
            isStoreSuccess = (0, _storage.setToken)(backendToken);
            if (isStoreSuccess) {
              _context.next = 26;
              break;
            }
          ...
          case 30:
            ...
            console.error("登录流程异常：", _context.t0);
            // 异常时清除无效 Token，避免残留
            (0, _storage.removeToken)();
            return _context.abrupt("return", {
              success: false,
              message: _context.t0.message || "登录失败，请重试"
            });
          case 35:
            _context.prev = 35;
            // 无论成功/失败，释放登录锁
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            token = (0, _storage.getToken)(); // 简单校验：本地存在 Token 即视为有效（复杂校验可后续对接后端 Token 验证接口）
            if (token) {
              _context2.next = 3;
              break;
            }
...
/***/ 34:
/*!*******************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/utils/storage.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.setToken = exports.removeToken = exports.getToken = void 0;
// utils/storage.js：Token 本地存储（uni-app 跨环境兼容）
var TOKEN_KEY = 'wx_miniprogram_token'; // 定义 Token 存储的 key
...
/***/ 35:
/*!**************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/api/demo.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.wxPay = exports.wxLogin = exports.userTradeRecord = exports.userShare = exports.teamInfo = exports.sysParams = exports.shareGiveCoin = exports.setCourseGoal = exports.recharge = exports.queryTeamWordRanking = exports.queryStageList = exports.queryPlayer = exports.queryLeagueList = exports.queryHomeList = exports.queryHomeAndVisitingGoalOdds = exports.queryHhgg = exports.queryGroupAndRoundList = exports.queryFootballForEntry = exports.queryFootBallLLottery = exports.queryContinentList = exports.queryBasketballForEntry = exports.queryBasketBallLLottery = exports.queryBasePermissionNeed = exports.purchasingLotteryQueryById = exports.purchasingLotteryConfirm = exports.purchasingLotteryApply = exports.purchasingFootballPoints = exports.purchasingFootballInfo = exports.purchasingBasketballInfo = exports.platformSysMessageRead = exports.platformSysMessageQuery = exports.payConfirm = exports.loginPhone = exports.getbasketballAi = exports.getUser = exports.getTimeList = exports.getSheShou = exports.getSaiCheng = exports.getPredictNumbers = exports.getJiFen = exports.getHaveMoney = exports.getH5Token = exports.getH5ShareInfo = exports.getAi = exports.footballLotteryTraditionDrawNum = exports.footballLotteryTradition = exports.footballLotteryEntry = exports.footLotteryLive = exports.checkCode = exports.basketballLotteryEntry = exports.basketLotteryLive = void 0;
var _request = _interopRequireDefault(__webpack_require__(/*! ./request */ 36));
var baseUrl = "";
baseUrl = "";
var queryBasePermissionNeed = function queryBasePermissionNeed(params) {
...
exports.queryBasePermissionNeed = queryBasePermissionNeed;
var queryContinentList = function queryContinentList(params) {
  return (0, _request.default)({
...
exports.queryContinentList = queryContinentList;
var queryLeagueList = function queryLeagueList(params) {
  return (0, _request.default)({
...
exports.queryLeagueList = queryLeagueList;
var queryHomeList = function queryHomeList(params) {
  return (0, _request.default)({
...
var getSaiCheng = function getSaiCheng(params) {
  return (0, _request.default)({
...
exports.getSaiCheng = getSaiCheng;
var getJiFen = function getJiFen(params) {
  return (0, _request.default)({
    url: baseUrl + '/sports/football/queryPoints',
    method: 'GET',
    data: params
...
exports.getJiFen = getJiFen;
var getSheShou = function getSheShou(params) {
  return (0, _request.default)({
...
exports.getSheShou = getSheShou;
var queryGroupAndRoundList = function queryGroupAndRoundList(params) {
  return (0, _request.default)({
...
exports.queryGroupAndRoundList = queryGroupAndRoundList;
var getAi = function getAi(params) {
  return (0, _request.default)({
...
exports.getAi = getAi;
var getbasketballAi = function getbasketballAi(params) {
  return (0, _request.default)({
...
exports.getbasketballAi = getbasketballAi;
var getTimeList = function getTimeList(params) {
  return (0, _request.default)({
...
var queryStageList = function queryStageList(params) {
  return (0, _request.default)({
...
exports.queryStageList = queryStageList;
var getUser = function getUser(params) {
  return (0, _request.default)({
...
var getHaveMoney = function getHaveMoney(params) {
  return (0, _request.default)({
...
exports.queryBasketBallLLottery = queryBasketBallLLottery;
var loginPhone = function loginPhone(data) {
  return (0, _request.default)({
...
var checkCode = function checkCode(data) {
  return (0, _request.default)({
...
var setCourseGoal = function setCourseGoal(data) {
  return (0, _request.default)({
...
exports.queryHomeAndVisitingGoalOdds = queryHomeAndVisitingGoalOdds;
var queryTeamWordRanking = function queryTeamWordRanking(data) {
  return (0, _request.default)({
...
exports.queryTeamWordRanking = queryTeamWordRanking;
var wxLogin = function wxLogin(data) {
  return (0, _request.default)({
    url: baseUrl + '/auth/login/weChatMiniProgram',
    // 按你的后端实际接口路径调整
    method: 'GET',
    data: data
  });
...
var queryPlayer = function queryPlayer(data) {
  return (0, _request.default)({
...
exports.wxPay = wxPay;
var payConfirm = function payConfirm(data) {
  return (0, _request.default)({
...
exports.payConfirm = payConfirm;
var userShare = function userShare(data) {
  return (0, _request.default)({
...
exports.footballLotteryTraditionDrawNum = footballLotteryTraditionDrawNum;
var getH5Token = function getH5Token(data) {
  return (0, _request.default)({
...
var getH5ShareInfo = function getH5ShareInfo(data) {
  return (0, _request.default)({
...
exports.getH5ShareInfo = getH5ShareInfo;
var shareGiveCoin = function shareGiveCoin(data) {
  return (0, _request.default)({
...
exports.shareGiveCoin = shareGiveCoin;
...
var sysParams = function sysParams(data) {
  return (0, _request.default)({
...
var footballLotteryEntry = function footballLotteryEntry(data) {
  return (0, _request.default)({
...
// 2. 足球查询接口
exports.footballLotteryEntry = footballLotteryEntry;
var queryFootballForEntry = function queryFootballForEntry(data) {
  return (0, _request.default)({
...
// 3. 篮球查询接口
exports.queryFootballForEntry = queryFootballForEntry;
var queryBasketballForEntry = function queryBasketballForEntry(data) {
  return (0, _request.default)({
...
// 4. 篮球录入接口
exports.queryBasketballForEntry = queryBasketballForEntry;
var basketballLotteryEntry = function basketballLotteryEntry(data) {
  return (0, _request.default)({
...
exports.basketballLotteryEntry = basketballLotteryEntry;
...
var getPredictNumbers = function getPredictNumbers(data) {
  return (0, _request.default)({
...
/***/ 36:
/*!*****************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/api/request.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// 域名/协议逻辑
var domain = 'www.tianjifu.com/qwxt';
var protocol =  false ? undefined : 'https:';
var apiDomain = "".concat(protocol, "//").concat(domain);
...
// 白名单
var NO_TOKEN_WHITE_LIST = ['/auth/login/weChatMiniProgram', '/auth/login/weChatServiceAccount/getAppInfo', '/auth/login/weChatServiceAccount'];
console.log('[Request封装] Token豁免白名单：', NO_TOKEN_WHITE_LIST);

// 全局锁 + 重试队列
var isRefreshingToken = false; // 防重复授权/登录
var retryRequests = []; // 存储401后等待重试的请求
console.log('[Request封装] 初始化全局状态 - 刷新Token锁：%s，重试队列长度：%d', isRefreshingToken, retryRequests.length);

// 封装授权/登录逻辑（抽离复用）
var refreshToken = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    var newToken, _yield$import, h5WechatAuth, authSuccess, loginResult;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 4:
            ...
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(__webpack_require__(/*! @/utils/h5Auth.js */ 37));
            });
          case 12:
            _yield$import = _context.sent;
            h5WechatAuth = _yield$import.h5WechatAuth;
            _context.next = 16;
            return h5WechatAuth();
          case 16:
            authSuccess = _context.sent;
            newToken = (0, _storage.getToken)() || '';
          ...
          case 27:
            ...
            throw new Error("\u5C0F\u7A0B\u5E8F/App\u91CD\u65B0\u767B\u5F55\u5931\u8D25\uFF1A".concat(loginResult.msg || '未知错误'));
          case 30:
            newToken = loginResult.token;
            (0, _storage.setToken)(newToken); // 存储新Token
          ...
          case 33:
            ...
            retryRequests.forEach(function (cb, index) {
          ...
          case 40:
            ...
            console.error('[Request封装][refreshToken] 重新授权/登录失败：', _context.t0.message);
            // 失败：拒绝所有等待的请求
...
// 封装实际的请求逻辑（内部使用）
var doRequest = function doRequest(options, token) {
  var isNeedToken = !NO_TOKEN_WHITE_LIST.some(function (item) {
    return options.url.includes(item);
  });
  console.log('[Request封装][doRequest] 开始处理请求 - URL：%s，是否需要Token：%s，当前Token：%s', options.url, isNeedToken, token ? '有' : '无');
  return new Promise(function (resolve, reject) {
    // 构造请求头
    ...
    uni.request({
      ...
      success: function success(res) {
        ...
        if (res.data.code == 200) {
          ...
          console.warn('[Request封装][doRequest] 请求业务失败 - URL：%s，错误码：%s，错误信息：%s', options.url, res.data.code, res.data.msg || '无');
          reject(res.data);
        }
      },
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 6:
                  ...
                  h5WechatAuth = _yield$import2.h5WechatAuth;
                  _context2.next = 10;
                  return h5WechatAuth();
                case 10:
                  isAuthSuccess = _context2.sent;
                  loginResult = {
...
exports.resetAuthFlag = exports.h5WechatAuth = exports.getUrlParam = exports.clearAllCodeRelated = exports.checkH5Token = void 0;
var _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 30));
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 32));
var _storage = __webpack_require__(/*! ./storage */ 34);
var _demo = __webpack_require__(/*! @/api/demo.js */ 35);
...
var clearCodeInUrl = function clearCodeInUrl() {
...
var getUrlParam = function getUrlParam(name) {
  ...
  var value = r ? decodeURIComponent(r[2]) : null;
  console.log("[getUrlParam] \u622A\u53D6".concat(name, "\u7684\u503C\uFF1A"), value);
  console.log('[getUrlParam] ===== 提取参数结束 =====');
  return value;
};
...
var redirectToWechatAuth = function redirectToWechatAuth() {
  console.log('[redirectToWechatAuth] ===== 开始跳转授权页 =====');
  var appId = 'wx8e8d3d70ba87e33c';
  // 核心修改：redirectUri 改为当前页面的完整URL（而非固定首页）
  var currentUrl = window.location.href.split('#')[0]; // 去掉hash，避免微信授权回调异常
  var redirectUri = encodeURIComponent(currentUrl);
  var state = Date.now();
  var authUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".concat(appId, "&redirect_uri=").concat(redirectUri, "&response_type=code&scope=snsapi_base&state=").concat(state, "#wechat_redirect");
...
var getTokenByCode = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(code) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            backendCode = res.code || res.status;
            backendToken = res.data || res.token;
            if (!(backendCode != 200 || !backendToken)) {
              _context.next = 17;
              break;
            }
            throw new Error("\u540E\u7AEF\u8FD4\u56DE\u65E0\u6548Token\uFF1A".concat(res.msg || "授权失败"));
          case 17:
            // 仅存储Token，不调用任何删除操作（核心修复）
            (0, _storage.setToken)(backendToken);
          ...
          case 25:
            ...
            errMsg = _context.t0.message || '接口调用失败'; // uni.showToast({
            // 	title: errMsg,
            // 	icon: 'none',
            // 	duration: 5000
            // });
            console.error('[getTokenByCode] 换Token流程异常：', errMsg);
            (0, _storage.removeToken)(); // 失败才删Token
    ...
    }, _callee, null, [[7, 25, 33, 36]]);
  }));
  return function getTokenByCode(_x) {
    return _ref.apply(this, arguments);
  };
}();

// 校验Token有效性（和小程序checkToken对齐）
var checkH5Token = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
    var token, invalidToken, isValid;
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 5:
            token = (0, _storage.getToken)();
            invalidToken = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiI1IiwidXNlcklkIjoiNSIsIm9wZW5JZCI6Im9PRGRWMV9qc3VWdHVFRWYxbm9LQTZFbTFZcEUiLCJpc1N5c01hbmFnZSI6IjAiLCJ0aW1lU3RhbXAiOjE3Njk5OTk5MjQ3NDJ9.SDgOKGOnz6v6bMFOOuMP_znqXB-B3lFes6MO4tWWx7Q';
            console.log('[checkH5Token] 当前本地Token：', token);
            console.log('[checkH5Token] 无效Token对比值：', invalidToken);
            isValid = !!token && token !== invalidToken; // 新增：如果Token有效，标记已完成有效授权
            if (isValid) {
              hasValidAuth = true;
            }
  ...
  return function checkH5Token() {
    return _ref2.apply(this, arguments);
  };
}();

// 适配App.vue的clearAllCodeRelated（仅清理URL，不删Token）
exports.checkH5Token = checkH5Token;
var clearAllCodeRelated = function clearAllCodeRelated() {
  console.log('[clearAllCodeRelated] 仅清理URL中的code/state，不删Token');
  clearCodeInUrl();
};

// 核心：自动授权入口（优化重复执行问题）
exports.clearAllCodeRelated = clearAllCodeRelated;
var h5WechatAuth = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
    var h5TokenValid, code, authResult;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt("return", hasValidAuth);
          case 5:
            isAuthorizing = true;
            _context3.prev = 6;
            _context3.next = 9;
          ...
          case 20:
            ...
            return _context3.abrupt("return", authResult.success);
          case 24:
          ...
          case 31:
            ...
            console.error('[h5WechatAuth] 自动授权流程异常：', _context3.t0);
            isAuthorizing = false;
  ...
  return function h5WechatAuth() {
    return _ref3.apply(this, arguments);
  };
}();

// 新增：重置授权标记（供App.vue页面切换时调用，可选）
exports.h5WechatAuth = h5WechatAuth;
var resetAuthFlag = function resetAuthFlag() {
...
/***/ 41:
/*!****************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/config/env.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 42:
/*!*****************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/store/index.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _actions = _interopRequireDefault(__webpack_require__(/*! ./actions */ 46));
// store/index.js
...
/***/ 44:
/*!*****************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/store/state.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// store/state.js
var _default = {
  // 彩票 Tab 显隐状态（对应你之前的 isShowLottery）
  isShowLottery: false,
  // TabBar 当前选中索引（对应你之前的 currentTabIndex）
  currentTabIndex: 0,
  // 可扩展其他全局状态（如用户信息、主题色等）
  userInfo: null
};
exports.default = _default;
...
/***/ 45:
/*!*********************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/store/mutations.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  // 修改彩票 Tab 显隐状态
  SET_SHOW_LOTTERY: function SET_SHOW_LOTTERY(state, value) {
    state.isShowLottery = value;
  },
  // 修改 TabBar 当前选中索引
  SET_CURRENT_TAB_INDEX: function SET_CURRENT_TAB_INDEX(state, index) {
...
/***/ 46:
/*!*******************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/store/actions.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  fetchLotteryStatus: function fetchLotteryStatus(_ref) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var getLocation = function getLocation() {
        return new Promise(function (locResolve, locReject) {
      ...
      getLocation().then(function (_ref2) {
        var latitude = _ref2.latitude,
          longitude = _ref2.longitude;
        return (0, _demo.queryBasePermissionNeed)({
          jd: longitude,
          // jd=经度，wd=纬度（参数对应正确）
          wd: latitude
        });
...
/***/ 47:
/*!*******************************************************************************!*\
  !*** C:/Users/zxg00/Documents/HBuilderProjects/football-cup/utils/loading.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.formatTimeToMDWeekHM = formatTimeToMDWeekHM;
exports.getWeekdayFromTimeStr = getWeekdayFromTimeStr;
/**
...
function formatDateWithWeekday(date) {
  ...
  return "".concat(year, "-").concat(month, "-").concat(day, " ").concat(weekday, " ").concat(hours, ":").concat(minutes);
}
...
function getWeekdayFromTimeStr(timeStr) {
  // 1. 提取年月日（前8位：20251024 → 年2025、月10、日24）
  var year = parseInt(timeStr.slice(0, 4));
  var month = parseInt(timeStr.slice(4, 6)) - 1; // 月份从0开始（0=1月）
  var day = parseInt(timeStr.slice(6, 8));
...
function formatTimeToMDWeekHM(timeStr) {
  ...
  var month = String(date.getMonth() + 1).padStart(2, '0'); // 月份0开头，需+1
  ...
  return "".concat(month, "-").concat(day, " ").concat(week, " ").concat(hour, ":").concat(minute);
}
