...
var _editScore = _interopRequireDefault(__webpack_require__(/*! ./pages/edit/football/editScore.vue */ 188));
// @ts-ignore
...
/* harmony import */ var _editScore_vue_vue_type_template_id_24c7f2c2_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editScore.vue?vue&type=template&id=24c7f2c2&scoped=true& */ 189);
/* harmony import */ var _editScore_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editScore.vue?vue&type=script&lang=js& */ 191);
...
/* harmony import */ var _editScore_vue_vue_type_style_index_0_id_24c7f2c2_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./editScore.vue?vue&type=style&index=0&id=24c7f2c2&scoped=true&lang=scss& */ 193);
  ...
  methods: (_methods = {
    ...
    calculateScoreBonus: function calculateScoreBonus() {
      if (this.selectedMatchCount === 0 || this.betNotes === 0) {
        console.log("[奖金计算] 无选中场次，直接返回0区间");
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var currentOdds = [];
          console.log("\u3010\u8D5B\u4E8B".concat(match.serial_number, "\u3011\u539F\u59CB\u8D54\u7387sqt/pqt/fqt\uFF1A"), match.sqt || 0, match.pqt || 0, match.fqt || 0);
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              if (sc === "胜其它") {
                ...
                console.log("\u3010\u8D5B\u4E8B".concat(match.serial_number, "\u3011\u6BD4\u5206").concat(sc, " \u8BFB\u53D6\u8D54\u7387\u503C\uFF1A"), odd);
              } else if (sc === "平其它") {
          ...
          if (currentOdds.length === 0) {
            console.log("\u3010\u8D5B\u4E8B".concat(match.serial_number, "\u3011\u672C\u573A\u65E0\u6709\u6548\u5927\u4E8E0\u8D54\u7387\uFF0C\u7EC8\u6B62\u8BA1\u7B97\u8FD4\u56DE0\u533A\u95F4"));
            return "0.00元 ~ 0.00元（仅供参考以彩票奖金为主）";
          }
      ...
      console.log("[\u5956\u91D1\u8BA1\u7B97\u7ED3\u675F] \u6700\u5C0F\u500D\u7387\u4E58\u79EF".concat(minP, "\uFF0C\u6700\u5927\u500D\u7387\u4E58\u79EF").concat(maxP, "\uFF0C\u603B\u6CE8\u6570").concat(notes, "\uFF0C\u500D\u6570").concat(beishu, "\uFF0C\u5956\u91D1\u533A\u95F4\uFF1A").concat(fmt(minBonus), " ~ ").concat(fmt(maxBonus)));
